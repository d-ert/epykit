...
class MethylData:
    ...
    adata:
        ...
        :func:`pymethyl.io.build_anndata` or :func:`pymethyl.io.read_samples`.
    ...
    def sites(self) -> pd.DataFrame:
        ...
        :func:`pymethyl.intervals.annotate_features`.
        """
...
def _validate_adata(adata: "ad.AnnData") -> None:
    ...
    if missing_layers:
        raise ValueError(
            ...
            "Use pymethyl.io.read_samples() or pymethyl.io.build_anndata() "
