"""
epykit.intervals — Genomic interval algebra
===============================================
...
Usage
-----
>>> from epykit.intervals import tile_counts, annotate_features
>>> tiled = tile_counts(mdata.adata, window=1000, step=1000)
>>> adata_ann = annotate_features(mdata.adata, "hg38_promoters.bed")
"""

from epykit.intervals.tiling import annotate_cpg_islands, annotate_features, tile_counts
